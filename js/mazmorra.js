...
var jugador = function(){
  ...
  function meDieron(respuesta){

    var modal = document.getElementById("myModal");
    modal.style.display = "block";
    var texto = document.querySelector('.textoModal');
    var icono = document.querySelector('.fa');
    ...
    switch (respuesta) {
      case 'victoria':
        ...
        // fa-smile-o
        icono.classList.add('fa-smile-o');
        setTimeout(function(){
          icono.classList.remove('fa-smile-o');
       }, 3000);
        break;
      case 'Muerte':
        texto.textContent = "Te han matado"
        icono.classList.add('fa-frown-o');
        setTimeout(function(){
          icono.classList.remove('fa-frown-o');
       }, 3000);

        break;
      case 'KEY':
        texto.textContent = "Has obtenido la llave"
        // fa-key
        icono.classList.add('fa-key');
        setTimeout(function(){
          icono.classList.remove('fa-key');
       }, 3000);
        break;
    
      default:
        texto.textContent = "Vamos Bien"
        break;
    }
  ...
  this.texto = function(){
    ...
    ctx.fillText('Perdiste por puto', 100, 100);
    }
